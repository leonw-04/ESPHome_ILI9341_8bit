...
void ILI9341Display::end_command_() { 
  this->cs_pin_->digital_write(false);
...
void ILI9341Display::start_read_() {
  this->cs_pin_->digital_write(false);
  this->dc_pin_->digital_write(true);
  this->wr_pin_->digital_write(true);
  this->enable();
}
void ILI9341Display::end_read_() { this->disable(); }

void ILI9341Display::write_byte_(uint8_t value) {
...
uintt8 ILI9341Display::read_byte_(uint8_t value) {
...
void ILI9341Display::write_array_(const uint8_t *data_bytes, uint8_t num_data_bytes) {
